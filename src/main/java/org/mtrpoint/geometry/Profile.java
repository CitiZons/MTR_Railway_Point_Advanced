...
public record Profile(double gauge,double top,double headWidth,double footWidth,double railHeight,
                      Surface steel,Surface sleeper,String source,boolean automatic,ModelDetail detail) {
    public Profile(double gauge,double top,double headWidth,double footWidth,double railHeight,Surface steel,Surface sleeper,String source,boolean automatic){this(gauge,top,headWidth,footWidth,railHeight,steel,sleeper,source,automatic,null);}
