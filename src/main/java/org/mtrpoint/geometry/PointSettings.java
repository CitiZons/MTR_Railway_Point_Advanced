...
public record PointSettings(double lengthScale,double bladeLength,double throwDistance,double flangeway,
    ...
    public static final PointSettings DEFAULT=new PointSettings(.9,0,.12,.055,.6,.24,.12,.38,0,0,0,0,0,1,false,true,Map.of(),"",0,0,4,0,0,0,0,0,0,0);
    ...
    public static PointSettings of(double[] v,boolean f,boolean e,Map<Integer,Double> s,String p){return new PointSettings(v[0],v[1],v[2],v[3],v[4],v[5],v[6],v[7],v[8],v[9],v[10],v[11],v[12],v[13],f,e,s,p,v.length>14?v[14]:0,v.length>15?v[15]:0,v.length>16?(int)v[16]:0,extra(v,17),extra(v,18),extra(v,19),extra(v,20),extra(v,21),extra(v,22),extra(v,23));}
}
