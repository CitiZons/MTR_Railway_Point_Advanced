...
public final class TurnoutPanel {
    ...
    private void save(){
        ...
        try{
            ...
            current=PointSettings.of(values,current.movableFrog(),current.enabled(),current.sleeperShifts(),current.profileStyle(),current.sleeperPath(),current.sleeperOverrides(),current.addedSleepers(),current.guardEdits());
