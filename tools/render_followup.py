...
for name,center,scale in [(name,(0,13,0),30) for name in ['three-asymmetric-fixed','three-asymmetric-moving-0','three-asymmetric-moving-1','three-asymmetric-moving-2']]:
