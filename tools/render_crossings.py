...
for name,center,scale in [('diamond-acute',(0,0,0),7),('diamond',(0,0,0),4.6),('scissors',(0,0,0),11),('scissors-curved',(4,0,0),11)]:
    ...
    scene.render.filepath=str(root/(name+'-crossing-detail.png'));bpy.ops.wm.save_as_mainfile(filepath=str(root/(name+'-crossing-detail.blend')));bpy.ops.render.render(write_still=True)
